...
<div id="central">
<div id="header">
	<h1 class="header_text">Add TV Program Presenter</h1>
</div>
<div id="bottom_shadow">
	<img alt="banner" src="img/bottom_bg.png"/>
		...
		<div id="c_left">
			...
			<form name="imgUpload" action="presenter_save.php" method="post" enctype="multipart/form-data">
...
<!--                                    <option value=""></option>-->
				...
				<input value="" name="name" id="name" type="text"><br>
                                ...
                                <label for="logo">Presenter's Picture</label><br>
